  ...
  (function($, global) {
    ...
    App = (function() {
      ...
      App.prototype.delegateEvents = function() {
        this.entries.on("select", this.entries_select);
        this.entries.on("unselect", this.entries_unselect);
        this.entries.on("openinfo", this.openInfo);
        this.mapView.on("openedInfo", this.openedInfo);
        this.entries.on("closeinfo", this.closeInfo);
        return this.genresView.on("change:genre", this.changeGenre);
      };

      App.prototype.entries_select = function(entries) {
        this.mapView.build(entries);
        return this.listView.build(entries);
      };

      App.prototype.entries_unselect = function(entries) {
      ...
      App.prototype.openedInfo = function(info, marker) {};

      App.prototype.closeInfo = function(entry) {
        return this.mapView.closeOpenedInfo();
      };

      App.prototype.changeGenre = function(genreId) {
