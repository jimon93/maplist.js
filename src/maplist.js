  ...
  (function($, global) {
    ...
    App = (function() {
      ...
      App.prototype.data = function(data) {
        ...
        return Entries.getSource(data, this.options.parser).then(function(models) {
      ...
      App.prototype.build = function(entries) {
        ...
        return typeof (_base1 = this.options).afterBuild === "function" ? _base1.afterBuild(prop, entries) : void 0;
      };
      ...
      App.prototype.clear = function() {
        ...
        this.trigger("afterBuild", entries);
