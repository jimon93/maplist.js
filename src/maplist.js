  ...
  (function($, global) {
    ...
    App = (function() {
      ...
      App.prototype.start = function(data) {
        ...
        Entries.getSource(data, this.options).then(function(models) {
      ...
      App.prototype.changeGenre = function(key, val) {
        ...
        properties = {};
        if (_.isUndefined(val) || val === "__all__") {
          properties = _.omit(this.properties, key);
        } else {
          properties[key] = val;
          properties = _.extend(this.properties, properties);
        }
      ...
      App.prototype.changeProperties = function(properties) {
        ...
        this.trigger('changeProperties', this.properties);
        this.rebuild(this.properties);
        this.trigger('changedProperties', this.properties);
        return this;
      };
    ...
    Options = (function() {
      var defaults, extendDefaultOptions, extendOptions,
        _this = this;

      function Options(options) {
        _.extend(this, extendOptions(extendDefaultOptions(options)));
      }
      ...
      extendDefaultOptions = function(options) {
        ...
        return options = _.extend({}, defaults(), options);
      };
    ...
    Parser = (function() {
      function Parser(options) {
        ...
        this.finallyParse = __bind(this.finallyParse, this);
        this.parse = __bind(this.parse, this);
        this.execute = __bind(this.execute, this);
        this.defaultParser = __bind(this.defaultParser, this);
        this.parser = this.options.parser || this.defaultParser;
        this.afterParser = this.options.afterParser || _.identity;
      }

      Parser.prototype.defaultParser = function(data) {
        var parser;
      ...
      Parser.prototype.execute = function(data) {
        return this.finallyParse(this.afterParser(this.parse(data)));
      };
      ...
      Parser.prototype.finallyParse = function(entries) {
        var entry, _i, _len;
    ...
    Parser.XMLParser = (function() {
      ...
      function XMLParser(options) {
        ...
        this.execute = __bind(this.execute, this);
        this.defaults = __bind(this.defaults, this);        this.options = _.extend({}, _(this).result('defaults'), options);
      }
    ...
    Entry = (function(_super) {
      ...
      function Entry() {
        ...
        this.getExistPoint = __bind(this.getExistPoint, this);
        ...
        this.closeInfo = __bind(this.closeInfo, this);
        this.openInfo = __bind(this.openInfo, this);
        this.initialize = __bind(this.initialize, this);        _ref = Entry.__super__.constructor.apply(this, arguments);
        return _ref;
      }
      ...
      Entry.prototype.initialize = function(attributes, options) {
        ...
        options || (options = {});
        this.isPoint = this.getExistPoint();
      ...
      Entry.prototype.getExistPoint = function() {
    ...
    Entries = (function(_super) {
      ...
      function Entries() {
        ...
        this.initialize = __bind(this.initialize, this);        _ref1 = Entries.__super__.constructor.apply(this, arguments);
        return _ref1;
      }
      ...
      Entries.getSource = function(data, options) {
        var dfd, parser;
    ...
    HtmlFactory = (function() {
      function HtmlFactory(templateEngine, template) {
        ...
        this.getTemplateEngineName = __bind(this.getTemplateEngineName, this);
        ...
        if (this.template == null) {
          ...
          switch (this.getTemplateEngineName()) {
            case "_.template":
              ...
              break;
            case "$.tmpl":
              this.engine = _.bind(this.templateEngine, $, this.template);
              break;
            default:
      ...
      HtmlFactory.prototype.make = function(object) {
        ...
        if (this.getTemplateEngineName() === "$.tmpl") {
          res = _(res).map(function(dom) {
    ...
    MapView = (function(_super) {
      ...
      function MapView() {
        ...
        this.build = __bind(this.build, this);
        this.initialize = __bind(this.initialize, this);        _ref2 = MapView.__super__.constructor.apply(this, arguments);
        return _ref2;
      }
    ...
    ListView = (function(_super) {
      ...
      function ListView() {
        ...
        this.clear = __bind(this.clear, this);
        this.build = __bind(this.build, this);
        this.initialize = __bind(this.initialize, this);        _ref3 = ListView.__super__.constructor.apply(this, arguments);
        return _ref3;
      }
    ...
    GenresView = (function(_super) {
      ...
      function GenresView() {
        ...
        this.initialize = __bind(this.initialize, this);        _ref4 = GenresView.__super__.constructor.apply(this, arguments);
        return _ref4;
      }
