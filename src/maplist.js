...
(function() {
  ...
  (function($, global) {
    var App, AppDelegator, Entries, Entry, EntryViews, GenresView, HtmlFactory, ListView, MapView, Options, Parser, Source, log, _ref, _ref1, _ref2, _ref3, _ref4;
    log = function() {
      var args;
    ...
    Entry = (function(_super) {
      ...
      Entry.prototype.initialize = function(attributes, options) {
        ...
        return this.views = new EntryViews(this, options);
      };
      ...
      Entry.prototype.view = function(type) {
    ...
    EntryViews = (function() {
      function EntryViews(entry, options) {
        this.entry = entry;
        this.options = options;
      ...
      EntryViews.prototype.get = function(type) {
        if (!this.data.hasOwnProperty(type)) {
          this.data[type] = (function() {
            switch (type) {
              case "info":
      ...
      EntryViews.prototype.createInfo = function() {
        var content, htmlFactory, info;
        htmlFactory = this.options.infoHtmlFactory;
        content = this.entry.get('__infoElement') || htmlFactory.make(this.entry.toJSON());
        if ((content != null) && !!content.replace(/\s/g, "")) {
          info = new google.maps.InfoWindow({
            content: content
          });
          google.maps.event.addListener(info, 'closeclick', this.entry.closeInfo);
          return info;
        }
      };

      EntryViews.prototype.createMarker = function() {
        var icon, marker, position, shadow;
        ...
        google.maps.event.addListener(marker, 'click', this.entry.openInfo);
        return marker;
      };

      EntryViews.prototype.createList = function() {
        var content, htmlFactory;
        htmlFactory = this.options.listHtmlFactory;
        content = htmlFactory.make(this.entry.toJSON());
        if ((content != null) && !!content.replace(/\s/g, "")) {
          return $(content).addClass("__list").data("entry", this.entry);
        }
      };
    ...
    MapView = (function(_super) {
      ...
      MapView.prototype.build = function(entries) {
        ...
        for (_i = 0, _len = entries.length; _i < _len; _i++) {
          entry = entries[_i];
          entry.view('marker').setMap(this.map);
        }
      ...
      MapView.prototype.clear = function(entries) {
        ...
        for (_i = 0, _len = entries.length; _i < _len; _i++) {
          entry = entries[_i];
          _results.push(entry.view('marker').setMap(null));
        }
        return _results;
      };
    ...
    ListView = (function(_super) {
      ...
      ListView.prototype.build = function(entries) {
        ...
        for (_i = 0, _len = entries.length; _i < _len; _i++) {
          entry = entries[_i];
          _results.push((_ref4 = entry.view('list')) != null ? _ref4.appendTo(this.$el) : void 0);
        }
        return _results;
      };
      ...
      ListView.prototype.clear = function(entries) {
        ...
        for (_i = 0, _len = entries.length; _i < _len; _i++) {
          entry = entries[_i];
          _results.push((_ref4 = entry.view('list')) != null ? _ref4.detach() : void 0);
        }
        return _results;
      };
