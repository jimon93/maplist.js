...
(function() {
  ...
  (function($, global) {
    var App, Entries, Entry, Genres, HtmlFactory, List, Map, Parser, log;
      ...
      function Entries(source, maplist, options) {
        ...
        this.list = (function() {
          ...
          for (_i = 0, _len = source.length; _i < _len; _i++) {
            ...
            _results.push(new Entry(entryFactor, this.maplist, options));
          }
          return _results;
        }).call(this);
      }
    ...
    Entry = (function() {
      function Entry(attributes, maplist, options) {
        this.attributes = attributes;
        this.maplist = maplist;
        _.bindAll(this);
        this.info = this.makeInfo(options.infoHtmlFactory);
        this.marker = this.makeMarker();
        this.list = this.makeList(options.listHtmlFactory);
      }

      Entry.prototype.openInfo = function() {
        return this.maplist.openInfo(this.info, this.marker);
      };

      Entry.prototype.makeInfo = function(infoHtmlFactory) {
        var content, info;

        content = infoHtmlFactory.make(this.attributes);
        if (content != null) {
      ...
      Entry.prototype.makeMarker = function() {
        ...
        position = new google.maps.LatLng(this.attributes.lat, this.attributes.lng);
        marker = new google.maps.Marker({
          position: position,
          icon: this.attributes.icon,
          shadow: this.attributes.shadow
        });
        if (this.info != null) {
      ...
      Entry.prototype.makeList = function(listHtmlFactory) {
        ...
        content = listHtmlFactory.make(this.attributes);
        if (content != null) {
    ...
    List = (function() {
      ...
      List.prototype.build = function(entries) {
        ...
        for (_i = 0, _len = entries.length; _i < _len; _i++) {
          entry = entries[_i];
          _results.push((_ref = entry.list) != null ? _ref.appendTo(this.$el) : void 0);
        }
        return _results;
      };
      ...
      List.prototype.clear = function(entries) {
        ...
        for (_i = 0, _len = entries.length; _i < _len; _i++) {
          entry = entries[_i];
          _results.push((_ref = entry.list) != null ? _ref.detach() : void 0);
        }
        return _results;
      };
